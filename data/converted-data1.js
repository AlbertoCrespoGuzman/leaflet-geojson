...
function getData(){
    ...
    points["features"] = []
    colors = ["#ecfc00","#ff9933","#ff0000","#000000"]
    
    for (var i = 0; i < array.length; i++){
        var point = {}
        point["geometry"] = {}
        point["geometry"]["type"] =  "Point"
        point["geometry"]["coordinates"] = [ array[i]["longitude"],  array[i]["latitude"] ]
        console.log("id = " + point["geometry"]["coordinates"] )
        point["type"] = "Feature"
        point["properties"] = {}
        
        point['properties']["incidentcategory"] = array[i]["incidentcategory"]
        point['properties']["adddress"] = array[i]["street"] + " " + array[i]["city"] + " " + array[i]["country"]
    
        point["properties"]["popupContent"] = "<strong>Incident Category: </strong>" + point['properties']["incidentcategory"] + "<br/><br/><strong>Severity: </strong>" + array[i]["severity"] + "<br/><br/><strong>Address: </strong> " +  point['properties']["adddress"] + "<br/><br/><strong>Description: </strong>" + array[i]["description"]
    
        switch (array[i]["severity"]){
            case "Minor":
                point['properties']["color"] = colors[0]
                break
            case "Media":
                point['properties']["color"] = colors[1]
                break
            case "Moderate":
                point['properties']["color"] = colors[2]
                break
            case "Extreme":
                point['properties']["color"] = colors[3]
                break
            default:
                point['properties']["color"] = colors[0]
                break
